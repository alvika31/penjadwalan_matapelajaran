              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your NIS & password to login</p>
                  </div>
                  ...
                  <?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">NIS</label>
                      <div class="input-group has-validation">
                        <input type="text" name="nis" class="form-control" id="yourUsername" required>
