 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4 mt-3">
         ...
         <div class="px-5 pb-4 mt-4">
             ...
             <form method="post" class="user" action="<?= site_url('admin/update_jadwal_pelajaran') ?>">
                 <div class="form-group row">
                     <div class="col-sm-6 mb-3 mb-sm-0">
                         <label>Mata Pelajaran:</label>
                         <input type="text" name="nama_pelajaran" value="<?= $jadwal['nama_pelajaran'] ?>" class="form-control" id="exampleFirstName" required>
                         <input type="hidden" name="id_mapel" value="<?= $jadwal['id_mapel'] ?>" class="form-control" id="exampleFirstName" required>
                     </div>
                     <div class="col-sm-6 row">
                         <div class="col-6">
                             <label>Jam Awal:</label>
                             <input type="time" name="jam_awal" value="<?= $jadwal['jam_awal'] ?>" class="form-control" id="exampleLastName" required>
                         </div>
                         <div class="col-6">
                             <label>Jam Akhir:</label>
                             <input type="time" name="jam_selesai" value="<?= $jadwal['jam_selesai'] ?>" class="form-control" id="exampleLastName" required>
                         </div>
                     </div>
                 </div>
                 <div class="form-group row">
                     ...
                     <div class="col-sm-6 mb-3 mb-sm-0">
                         ...
                         <select class="form-control" name="id_ruangan" required>
                             <?php foreach ($ruangan as $ruangan) { ?>
                                 <option value="<?= $ruangan->id_ruangan ?>" <?= $jadwal['id_ruangan'] === $ruangan->id_ruangan ? 'selected' : '' ?>><?= $ruangan->nama_ruangan ?></option>
                             <?php } ?>
                         </select>
                     </div>
                     <div class="col-sm-6 mb-3 mb-sm-0">
